...
class NhaCungCapController extends Controller
{
    ...
    {
        return view('admin.nha_cung_cap');
    }

    public function getList(Request $request) {
        try {
            $items = NhaCungCap::whereNull('isDeleted');
            if($request->id_coso) {
    ...
    {
        try {
            $item = NhaCungCap::find($request->id);
            if(!$item) {
                $item = new NhaCungCap();
            }
            ...
            $item->tax_code = $request->tax_code;
