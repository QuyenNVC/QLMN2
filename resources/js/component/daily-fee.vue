    ...
    <div class="page-breadcrumb">
      <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
          <h4 class="page-title">Quản lý danh mục học phí theo ngày</h4>
  ...
  methods: {
    ...
    async fetchData() {
      await axios
        ...
        .then((response) => {
          if (response.data.status == true) {
            this.tableData = response.data.dailyfees;
