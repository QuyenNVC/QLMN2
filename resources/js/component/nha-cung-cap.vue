    ...
    <div class="page-breadcrumb">
      <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
          <h4>Quản lý danh mục nhà cung cấp</h4>
        ...
        <form-wrapper>
          ...
          <template>
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <span class="label-input">Mã số thuế: </span>
                  <el-input
                    type="text"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <span class="label-input">Số tài khoản: </span>
                  <el-input
                    type="text"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <span class="label-input">Ngân hàng: </span>
                  <el-input
                    type="text"
          ...
          <div class="col-12">
            <div class="wrap-table table-record">
              ...
              >
                ...
                <el-table-column label="Tên nhà cung cấp" prop="name">
                </el-table-column>
                <el-table-column label="Địa chỉ" prop="address">
                </el-table-column>
                <el-table-column label="Điện thoại" prop="phone">
                </el-table-column>
                <el-table-column label="Mả số thuế" prop="tax_code">
                </el-table-column>
                <el-table-column label="Tài khoản" prop="bank_account">
                </el-table-column>
                <el-table-column label="Ngân hàng" prop="bank">
                </el-table-column>
  ...
  methods: {
    ...
    handleDelete(index, row) {
      ...
      this.$confirm("Bạn thật sự muốn xóa dữ liệu này?", "Cảnh báo", {
        ...
        .then(async () => {
          await axios
            .post("/deleteNhaCungCap", { array: [row.id] })
            .then((response) => {
              if (response.data.status == true) {
                this.$notify({
                  title: "Thông báo",
                  message: `Xóa nhà cung cấp "${name}" thành công!`,
                  type: "success",
                });
                this.fetchData();
              } else {
    ...
    // phần xử lý form
    validateForm() {
      let stringPhonePattern = /((09|03|07|08|05)+([0-9]{8})\b)/g;
      if (this.form.name == "") {
        this.$notify({
          title: "Cảnh báo",
      ...
      if (this.form.phone !== "") {
        if (!this.form.phone.match(stringPhonePattern)) {
          this.$notify({
            title: "Cảnh báo",
    ...
    handleEdit(row) {
      this.title = `Cập nhật nhà cung cấp "${row.name}"`;
              ...
              if (response.data.status) {
                ...
                this.$notify({
                  ...
                  message: !this.form.id
                    ? `Thêm nhà cùng cấp "${this.form.name}" thành công!`
                    : `Cập nhật nhà cung cấp "${this.form.name}" thành công!`,
                  type: "success",
                });
                this.resetForm();
                return true;
