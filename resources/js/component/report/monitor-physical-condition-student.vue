            ...
            <div class="card filter_form">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group-input d-block d-lg-flex">
                    <span class="label-input">Danh hiệu: </span>
                    <el-select
            ...
            <div class="wrap-table table-record">
              ...
              >
                ...
                >
                  <template
                    slot-scope="scope"
                    v-if="scope.row.birth_date || scope.row.time_end"
                  >
                    {{ renderMonthAge(scope.row.birth_date) }}
                  </template>
                </el-table-column>
                <el-table-column
                  label="H-Tiêu chuẩn (cm)"
                  prop="gender"
                  header-align="center"
                  width="100"
                >
                  <template
                    slot-scope="scope"
                    v-if="scope.row.time_start || scope.row.time_end"
                  >
                    {{ scope.row.time_start | formatDate }} -
                    {{ scope.row.time_end | formatDate }}
                  </template>
                </el-table-column>
                <el-table-column
                  label="Chiều cao (cm)"
                ...
                <el-table-column
                  label="Đánh giá chiều cao"
                  prop="evaluate_height"
                  header-align="center"
                  width="100"
                >
                </el-table-column>
                <el-table-column
                  label="W-Tiêu chuẩn (kg)"
                  prop="grade_name"
                  header-align="center"
                  width="100"
                >
                ...
                <el-table-column
                  label="Đánh giá cân nặng"
                  prop="evaluate_weigth"
                  align="center"
                  width="100"
                >
                </el-table-column>
                <el-table-column
                  label="Đánh giá sức khỏe/thể chất"
                  prop="evaluate_physical"
                  align="center"
                  width="100"
                >
                </el-table-column>
                <el-table-column
                  label="Phát triển nhận thức"
                  prop="cognitive_development"
                  align="center"
                  width="100"
                >
                </el-table-column>
                <el-table-column
                  label="Phát triển năng khiếu"
                  prop="talent_development"
                  align="center"
                  width="100"
                >
                </el-table-column>
                <el-table-column
                  label="Phát triển tình cảm và quan hệ xã hội"
                  prop="relationship_development"
                  align="center"
                  width="100"
                >
                </el-table-column>
                <el-table-column
                  label="Phát triển ngôn ngữ"
                  prop="language_development"
                  align="center"
                  width="100"
                >
                </el-table-column>
                ...
                >
                  <template
                    slot-scope="scope"
                    v-if="scope.row.be_khoe && scope.row.be_khoe == 1"
                  >
                ...
                >
                  <template
                    slot-scope="scope"
                    v-if="scope.row.be_ngoan && scope.row.be_ngoan == 1"
                  >
                    <input type="checkbox" checked disabled />
                  </template>
                </el-table-column>
...
export default {
  name: "monitor-physical-condition-student",
  components: {
    multiselect,
    FooterQlmn,
  },
  ...
  methods: {
    ...
    async exportExcel() {
      this.loading = true;
      await axios
        .post("monitor-physical/export-excel", {
