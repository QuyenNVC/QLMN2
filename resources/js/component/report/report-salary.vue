            ...
            <div class="row">
              <div class="col-12">
                <div class="card filter_form">
                  ...
                  >
                    <el-button type="" @click="resetFilter()"
                      >Làm mới</el-button
                    >
                ...
                <div class="wrap-table table-record">
                  ...
                  >
                    ...
                    >
                      <template slot-scope="scope">
                        {{ scope.row.salary_day | formatMoney }}
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="Ứng lương"
                    ...
                    >
                      <template slot-scope="scope">
                        {{ scope.row.salary_advance | formatMoney }}
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="Phụ cấp"
                    ...
                    >
                      <template slot-scope="scope">
                        {{ scope.row.allowance | formatMoney }}
                      </template>
                    </el-table-column>
                    <el-table-column
                    ...
                    >
                      <template slot-scope="scope">
                        {{ scope.row.fluctuate | formatMoney }}
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="Tiền lương"
...
export default {
  ...
  methods: {
    ...
    async exportExcel() {
      this.loading = true;
      await axios
        .post("report-salary/export-excel", {
