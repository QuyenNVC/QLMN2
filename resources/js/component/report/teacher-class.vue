    ...
    <div class="page-breadcrumb">
      <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
          <h4>Thống kê giáo viên phụ trách lớp</h4>
              ...
              >
                <el-table-column width="40" align="center">
                  ...
                  <template slot-scope="scope">
                    <input
                      type="checkbox"
                      :checked="checkSelected(scope.row.id_class)"
                      @change="changeSelectedRecord(scope.row.id_class)"
                    />
                  </template>
                </el-table-column>
                <el-table-column
                ...
                <el-table-column
                  ...
                  width="150"
                >
                  <template slot-scope="scope" v-if="scope.row.class_room">
                    {{ renderAddress(scope.row.class_room) }}
                  </template>
                </el-table-column>
              </el-table>
            </div>
...
export default {
  ...
  methods: {
    ...
    async exportExcel() {
      this.loading = true;
      await axios
        .post("teacher-class/export-excel", {
          class_ids: this.selected,
