    ...
    <div class="page-breadcrumb">
      <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
          <h4 class="page-title">Quản lý ứng lương nhân viên</h4>
        ...
        <div class="col-12">
          <div class="card" v-show="isShowCreate">
            <div class="card-body">
              ...
              <h5 class="card-title mb-0">
                Ứng lương nhân viên <span class="strong-name">"{{ nameUpdate }}"</span>
              </h5>
            </div>
            ...
            <div class="form-group-input">
              <p style="font-style: italic">Lưu ý: Tiền ứng sẽ được cộng thêm vào</p>
              <el-input placeholder="Tiền ứng" v-model="form.tien_ung"></el-input>
            </div>
          ...
          <div class="wrap-table">
            ...
            >
              ...
              <el-table-column label="Tiền Ứng">
                <template slot-scope="scope">
                  {{ scope.row.tien_ung | formatMoney }}
                </template>  
              </el-table-column>
  ...
  methods: {
    ...
    async handleCreate() {
      if (this.validateForm()) {
            await axios.post("updateUngLuongNhanVien", {
              thang: this.month,
              nam: this.year,
              phuCap: this.form
              }).then((response) => {
                if (response.data.status == true) {
                    ...
                    this.$notify({
                    title: "Thông báo",
                    message: `Cập nhật ung_luong cho nhân viên "${this.nameUpdate}" thành công!`,
                    type: "success",
                    });
                    this.resetForm();
                } else {
    ...
    validateForm() {
      if (this.form.tien_ung == "") {
        this.isErrorForm = true;
        this.titleMessage = "Tiền ứng không được để trống";
        return false;
      }
